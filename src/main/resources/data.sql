...
insert into GOODS (member_id, goods_name, price, description, category_id) values (2,'아디다스1' , '60000', '설명6', 2);
insert into GOODS (member_id, goods_name, price, description, category_id) values (2,'아디다스2' , '70000', '설명7', 2);
