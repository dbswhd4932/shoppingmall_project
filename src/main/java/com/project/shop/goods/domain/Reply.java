...
public class Reply extends BaseTimeEntity {
    ...
    // 대댓글 생성
    public static Reply createReply(Review review, ReplyCreateRequest replyCreateRequest) {
    ...
    // 대댓글을 작성한 회원인지 확인
    public void checkReply(Long goodsMemberId) {
        if (!review.getGoods().getMemberId().equals(goodsMemberId)) {
